...
const article: PostContent = {
  ...
  body: [
    <p key="0">
      The work <i>Huacal Wall</i> was inspired by two different places/phases in
      Mexican history:
    </p>,
    <p key="1">
    ...
    <p key="2">
      <b>Huacal City</b> can be found at the largest market in Mexico City. It
      is a gigantic area with thousands of <i>huacales</i> – wooden fruit boxes.
      <i>Huacales</i> are repaired here so that they can be reused, making it
    ...
    <p key="2">
      ...
      Mexican people have a positive attitude toward life, though. Despite
      difficult conditions, people always find a way to survive
    </p>,
  ],
};
