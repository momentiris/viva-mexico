...
const theOfrendaTheAltar: Post = {
  ...
  body: [
    <span key="0">
      ...
      The altar is dedicated the relatives who have passed away during the year
      and the most significant in the family from previous years. Sometimes the
      altar is dedicated to a special person. The altar is filled with flowers,
      food, beverages, photographs and fruit – everything that the dead liked in
      life. Some dishes, like pan de muertos (bread of the dead), are baked only
      during this season.
    </span>,
    <span key="1">
      The first to return from the world of the dead are usually the children (
      <i>los angelitos</i>). Tables filled with lots of candy and toys are
      created for them. The four elements – earth, air, fire and water – are
      included on the altar as important symbols. A glass of water, lit candles
      for fire, fruit symbolizing the earth, and paper figures representing the
      wind.
    </span>,
  ],
  labelTexts: [],
...
const calaverasSkulls: Post = {
  ...
  body: [
    <span key="0">
      Skulls, or <i>calaveras</i> as they’re called in Spanish, play a major
      role on <i>Día de Muertos</i>. They are used as decorations everywhere, in
      various shapes and materials. The skulls represent ancestors and the close
...
export const diaDeMuertos: Theme = {
  ...
  content: [
    {
      label: 'Day of the Dead – the most important celebration?  ',
      introduction: {
        ...
        },
        {
          ...
          body: [
            <span key="0">
              ...
              The traditions are a way of building a bridge between life and
              death. To be able to meet again whether you are dead or alive.
            </span>,
          ],
          photographTexts: [
        ...
        },
        {
          ...
          body: [
            <span key="0">
              ...
              more public and commercial. A new tradition is the carnival-style
              parade in Mexico City - a colorful spectacle of grand carnival
              floats, dances and costumes. The parade was first performed in
              2015, inspired by scenes from the Bond film Spectre.
            </span>,
            <span key="0">
              In the cities, enormous altars are erected as pure art
