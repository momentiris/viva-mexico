export const salvationOfTheSoul = {
  ...
  body: [
    <span key="0">
      ...
      Apanohuacalhuia. The dog Xolo, Xoloitzcuintle, helps the deceased cross
      over to the underworld of Mictlán.
    </span>,
  ],
};
...
export const xolotl = {
  ...
  body: [
    <span key="0">
      ...
      in the underworld. It also guides the sun as it sets in the sea and on its
      journey through the underworld before rising again. The dog Dante in the
      movie Coco is inspired by the god Xolotl.
    </span>,
  ],
};
...
export const xipeTotec = {
  ...
  body: [
    <span key="0">
      ...
      corn farming. He is also known as Tezcatlipoca. Corn was the most
      important food for humans and the cycles of cultivation were closely
      linked to human life and death.
    </span>,
  ],
};
...
export const roadToEmptiness = {
  ...
  body: [
    <span key="0">
      ...
      trials to reach Mictlán. They had to let go of everything that bound them
      to life.
    </span>,
  ],
};
...
export const mictlantecuhtli = {
  ...
  body: [
    <span key="0">
      ...
      to the underworld of Mictlán. Here the souls of the people continued to
      exist. Just as light cannot be seen without darkness, life cannot exist
      without death.
    </span>,
  ],
};
