const theRevolutionAndTheSearchForCulturalGoods = {
  heading: <h2>The revolution and the search for cultural roots</h2>,
  body: [
    <p key="0">
  ...
  objectTexts: [
    {
      heading: <h1>Frida Kahlo in Tehuana dress</h1>,
      body: (
        <p>
...
const tehuanaWomensParadesAndFestivals = {
  heading: <h2>TEHUANA WOMEN’S PARADES AND FESTIVALS</h2>,
  body: [
    <p key="0">
...
const independenceDayCelebrations = {
  heading: <h2>Independence Day Celebrations</h2>,
  body: [
    <p key="0">
